...
- [superpowers](https://github.com/obra/superpowers) and its [plugin page](https://claude.com/plugins/superpowers)
- [feature-dev](https://github.com/anthropics/claude-code/tree/main/plugins/feature-dev)
- [caveman](https://github.com/JuliusBrussee/caveman)
- [aihero.dev](https://www.aihero.dev/): skill authoring material
...
- [Continue for VS Code](https://marketplace.visualstudio.com/items?itemName=Continue.continue)

## Contributing a resource

Add a link with one sentence on why it is worth the time. Links without a reason get removed.
